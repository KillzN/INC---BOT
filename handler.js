...
export async function handler(chatUpdate) {
  ...
  /* Creditos a Otosaka (https://wa.me/51963318746) */
    ...
    case 'remove':
      if (chat.welcome && !chat?.isBanned) {
        ...
        for (const user of participants) {
          let pp = 'https://raw.githubusercontent.com/KillzN/INC-BOT/master/src/avatar_contact.png';
          try {
