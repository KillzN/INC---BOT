...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} Fati
  ${tradutor.texto1[2]} +51963318746
  ...
  const Message = {
    document: { url: `https://www.instagram.com/comunidad_incas/` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/comunidad_incas/",
        mediaType: 2,
        previewType: "pdf",
        title: "Fati",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/comunidad_incas/",
      },
    },
    caption: info,
    footer: wm,
